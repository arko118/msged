...
public class studentpaiddis_update extends HttpServlet{
Connection con=null;
...
//out.println("</table><a href=/msged/servlet/admitcard?id="+sid+"&batch="+b+">Admit Card</a>"); 
...
out.println("<FORM> <INPUT TYPE=button VALUE=\"Admit Card\" onClick=\"open4();\"></FORM>");
