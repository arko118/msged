...
public class remote_pkg extends HttpServlet{
Connection con=null;
...
ResultSet rs=stmt.executeQuery("select id,date,year,name,batch,course_semester1,course_semester2,course_semester3,trimester1,trimester2,trimester3,weber,thesis_title,passed,cgpa,1st_Supervisor_Name,2nd_Supervisor_Name,pkg from studentinfo where pkg='8' ");
...
out.println("<tr><td class=style1>"+id+"  </td> <td class=style1> "+date+" </td> <td class=style1> "+name+" </td> <td class=style1> "+batch+" </td><td class=style1> "+thesis_title+" </td><td class=style1> "+ist_Supervisor_Name+" </td><td class=style1> "+iind_Supervisor_Name+" </td> <td class=style1> "+pakg+" </td></tr> ");
