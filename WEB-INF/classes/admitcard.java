...
out.println(".sign{padding:0px; padding-top: 0px; padding-bottom: 0px; font-family: arial, verdana, serif; TEXT-DECORATION: none; image:('/msged/stuinfo/admidcard/r.jpg'); background-color:; bold: 2px; color:; font-size: 18px;color:blue; border: #feaaee solid 0px; } ");
...
out.println("<tr><td></td><td  class=style3 class=styles><center>Master in GIS for Environment & Development<br>Jahangirnagar University</center></td></tr>");
out.println("<tr> <td></td> <td  class=style1 ><center>Admit Card</center></td></tr>");
out.println("</table></div> "); 



out.println("<table border=0 width=150 height=125 align=top> ");
...
out.println("<tr> <td></td>   <td></td> <td><font color=white>"+x.getUserName()+"</font></td> </tr>");
...
out.println(" <table align=right><tr><td><img src=/msged/stuinfo/admidcard/ni.jpg width=100 height=40></td>  </tr><tr><td>Coordinator<br>MSGED Program </td>  </tr></table>");
...
String message = "Accountant(MSGED Program)";
out.println(" function printpage() {window.print();} ");
out.println("</SCRIPT>");
out.println("<table align=left><tr><td><img src=/msged/stuinfo/admidcard/r.jpg width=88 height=35></td></tr><tr><td class=font1><FORM> <INPUT TYPE=button VALUE=\" "+message+" \" onClick=\"printpage()\"></FORM></td> </tr></table>");
