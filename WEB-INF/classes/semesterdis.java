...
public class semesterdis extends HttpServlet{
Connection con=null;
...
Shoppingbean t_student=new Shoppingbean();

String allbatch=req.getParameter("batch");
...
ResultSet rs=stmt.executeQuery("SELECT id,month,date,years,batch,name,semester1,semester2,semester3,totalpaid,chequeno,bankname,passed,cgpa FROM `studentpaid` WHERE batch=\'"+allbatch+"\' and NOT "+semester+"=\'\' ");
...
out.println("<tr><td>"+date+"  </td> <td> "+month+" </td>  <td> "+year+" </td><td> "+name+" </td> <td> "+id+" </td> <td> "+batch+" </td><td> "+semester1+" </td><td> "+semester2+" </td><td> "+semester3+" </td><td> "+totalpaid+" </td><td><a href=/msged/Slip/larger_image/semesterdis.jsp?batch="+allbatch+"&semester="+semester+"&id="+id+"&month="+month+"> <img src=/msged/Slip/"+batch+"/"+id+"/"+month+".jpg width=75 height=50></a></td><td><a href=/msged/Slip/larger_image/semesterdis.jsp?batch="+allbatch+"&semester="+semester+"&id="+id+"&month="+month+"> <img src=/msged/Slip/"+batch+"/"+id+"/"+id+".jpg width=75 height=50></a> </td> <td></td> <td> "+pass+" </td> <td> "+cgpa+" </td></tr> ");
...
out.println("<tr><td>   </td>  <td>  </td> <td> </td><td> </td> <td></td><td>  </td><td><font color=red>Total= "+x.getTotal()+"</font></td><td><font color=red>Total= "+y.getTotal()+"</font></td><td><font color=red>Total= "+z.getTotal()+"</font></td><td></td><td>  </td>  </tr> ");
