...
.div1{color: #227722; font-size: 32px; font-weight: bolder; padding-left: 0px; padding-bottom: 0px; text-decoration: none;}


.mainstyle1{ padding:10px; padding-top: 0px; padding-bottom: 0px; font-family: arial, verdana, serif;  TEXT-DECORATION: none; color: rgb(0,0,0);  
		background-image: url(''); font-size: 18px;color:white; border: #feaaee solid 1px; }
...
.row1{background-color: lightblue;}
.row2{background-color: lightblue;}
</style>
...
<!--GetInvolved Start-->
<center>
<div id="Menu251" style="border: 0px solid rgb(0, 0, 0); position: absolute; visibility: hidden; z-index: 1;  top: 123px;">
<table style="border-collapse: collapse;" cellpadding="0" cellspacing="0">
<tbody>

<tr style="background-color: rgb(230, 245, 230);" class="mainstyle" onmouseout="menuOut(this,1)" onmouseover="menuOver(this)" height="40">
<td align="left"><a class="mainstyle" href="/msged/stuinfo/frame/frontwindow/Md.Nazrul/mdnazrulusermanu.jsp">Academic Status</a> </td></tr>

<tr style="background-color: rgb(230, 245, 230);" class="mainstyle" onmouseout="menuOut(this,1)" onmouseover="menuOver(this)" height="40">
<td align="left"><a class="mainstyle" href="/msged/stuinfo/frame/frontwindow/Md.Nazrul/award.jsp">Academic Award</a></td></td></tr>
...
<td align="center">
<a id="251" onmouseout="btnTimer()" onmouseover="showLayer(&quot;Menu251&quot;,'251')" href="" target="" class="mainstyle1">Academic</a>
...
<div align="right" class="div1"><br><br>
<table bgcolor= magenda border=1 width=500px>
<tr>
<td >
<br><br>
<p>Award</p>
