...
%>
 ...
 <%
String tr1=request.getParameter("trimester1");
%>
<%
String tr2=request.getParameter("trimester2");
%>
<%
String tr3=request.getParameter("trimester3");
%>
...
out.println("<input type=hidden name=tr1 value="+tr1+"> ");
out.println("<input type=hidden name=tr2 value="+tr2+"> ");
out.println("<input type=hidden name=tr3 value="+tr3+"> ");
