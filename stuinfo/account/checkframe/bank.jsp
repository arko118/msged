...
.mg1{ padding: 0px; padding-top: 0px; padding-bottom: 0px; font-family: arial, verdana, serif;  TEXT-DECORATION: none; color: rgb(0,0,0);  
		background-image: url('/shopping/image/bg1.jpg');
	        font-size: 15px;color:magenta; border: #feaaee solid 0px;
     }
...
<!--GetInvolved Start-->
<div id="Menu251" style="border: 0px solid rgb(0, 0, 0); position: absolute; visibility: hidden; z-index: 1;  top: 53px;">
...
<iframe src=/msged/servlet/bank width=400 height=50 scrolling="no" frameborder="1"></iframe>  </td><td>
<a id="251" onmouseout="btnTimer()" onmouseover="showLayer(&quot;Menu251&quot;,'251')"  href="/msged/stuinfo/account/checkframe/studentpaidframe.jsp" target="/msged/stuinfo/account/checkframe/checkdisplay.jsp"  class="mg1" >Student_Deposite</a>
