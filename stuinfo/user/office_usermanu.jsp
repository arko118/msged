...
.mainstyle{ padding: 0px; padding-top: 0px; padding-bottom: 0px; font-family: arial, verdana, serif;  TEXT-DECORATION: none; color: rgb(0,0,0);  
		background-image: url(''); font-size: 14px;color:blues; border: #feaaee solid 0px; }
...
<!-- <img src=/shopping/image/template/rtm2.jpg > -->
...
<a id="250" onmouseout="btnTimer()" onmouseover="showLayer(&quot;Menu250&quot;,'250')" href="/msged/frame/frame1" target="/msged/stuinfo/user/studentfrontwindow.jsp" class="mainstyle"> hh &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
</div>
</td>
